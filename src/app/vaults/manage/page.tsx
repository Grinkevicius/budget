            ...
            <div className="flex flex-col space-y-6 ">
                ...
                {vault ? (
                    ...
                    <div className="relative h-[115px] md:h-auto rounded-lg overflow-hidden">
                        ...
                        <div className="relative p-6 md:h-[200px] space-y-6">
                            <div
                        ...
                        <Tabs defaultValue="activity" className="w-full">
                            ...
                            <TabsContent  value="activity">
                                <div className="space-y-4">
                                    {
                                        vault.transactions.map((t : TransactionInterface) => (
                                                <Transaction
                                                    key={t.referencecode}
                                                    color={theme === "dark" ? "#629584" : "rgb(220, 252, 231)"}
                                                    {...t}
                                                />
                                        ))
                                    }
                            ...
                            <TabsContent value="notes">
                                <Card className="p-4">
                                    ...
                                    {
                                        vault.notes.map((note : { referencecode: string, content: string }) => (
                                                <p key={note.referencecode}>{note.content || "No notes added yet."}</p>
                                        ))
                                    }
